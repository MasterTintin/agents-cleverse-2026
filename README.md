...
The following diagram illustrates the high-level architecture of the Private Skills proof of concept.

<p align="center">
  <img
    src="docs/images/architecture.png"
    alt="Private Skills Architecture"
    width="720">
</p>

The frontend communicates only with the Gateway, while confidential prompts remain inside the Protected Skill Service. The client only receives structured edit instructions generated by the AI.
...
The current prototype demonstrates the end-to-end workflow described above, from opening a contract to applying suggested edits.

_A GIF or short video walkthrough will be added here._
